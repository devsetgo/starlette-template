...
from api.users import endpoint_paths as users_routing
from api.search import endpoint_paths as search_routing

routes = [
    Route("/", endpoint=index_endpoints.index, methods=["GET"]),
    ...
    Mount("/users", name="users", routes=users_routing.endpoint_routes),
